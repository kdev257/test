...
def retrieve_mrn(request,mrn_no):
    # This view retrieves the MRN based on the mrn_no provided in the URL
    try:
        mrn = Material_Receipt_Note.objects.get(mrn_no=mrn_no)
        return render(request, 'inventory/mrn_detail.html', {'mrn': mrn})
...
def receipt_matching(request,id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            matching_instance.matching_status = True
            ...
            supplier_account = matching_instance.supplier.account
